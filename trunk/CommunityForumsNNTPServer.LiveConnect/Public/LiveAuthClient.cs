using CommunityForumsNNTPServer.LiveConnect.Internal;
using CommunityForumsNNTPServer.LiveConnect.Internal.Utilities;
using System;
...
namespace CommunityForumsNNTPServer.LiveConnect.Public
{
  /// <summary>
    ...
    public class LiveAuthClient : INotifyPropertyChanged
    {
        ...
        public bool ForceRefreshToken(Action<LiveLoginResult> completionCallback)
        {
          if (this.authClient.CanRefreshToken)
          {
            this.authClient.TryRefreshToken(completionCallback);
            return true;
          }
