...
namespace CommunityForumsNNTPServer.NNTPServer
{
    ...
    {
        //private Timer _articlesInvalidationTimer;
        ...
        protected DataProvider()
        {
            ...
            _articlesCacheCheckTimer.Elapsed += new ElapsedEventHandler(_articlesCacheCheckTimer_Elapsed);
        }
        ...
        /// <returns></returns>
        public abstract Newsgroup GetNewsgroup(string clientUsername, string groupName, bool updateFirstLastNumber);

        ///// <summary>
        ///// Returns a newsgroup from the cached list.  If the user does not permission
        ///// NULL is returned.
        ///// </summary>
        ///// <param name="clientUsername">Authenticated username</param>
        ///// <param name="groupName">Name of the newsgroup</param>
        ///// <returns>Newsgroup object</returns>
        //public Newsgroup GetNewsgroup(string clientUsername, string groupName)
        //{
        //    Dictionary<string, Newsgroup> groupList = GetNewsgroupListWithoutTrimming();

        //    Newsgroup group = null;

        //    try
        //    {
        //        group = _groupList[groupName];
        //    }
        //    catch (KeyNotFoundException)
        //    {
        //        // continue
        //        group = null;
        //        //System.Diagnostics.Trace.WriteLine("Failed to access group list for group [" + groupName + "]");
        //    }
        //    catch (Exception ex)
        //    {
        //        Logging.Error("Failed to access group list for group [" + groupName + "]", ex);
        //    }

        //    if (group != null &&
        //        !HasUserPermissionOnGroup(clientUsername, group, false, true))
        //    {
        //        group = null;
        //    }
        ...
        //public Article GetArticleByID(string clientUsername, string groupName, string articleID)
        //{
        ...
        //            {
        //                if (key.Value.ID.ToLower() == articleID.ToLower())
        //                {
        //                    return key.Value;
        //                }
        //            }
        ...
        private void ReEncode(Article article, string charSet)
        {
            ...
            catch (Exception)
            {
                Traces.NntpServerTraceEvent(
                    ...
                    "PostArticle: Could not convert into the desired charset: {0}",
                    article.ContentType);
            }
        }
