...
namespace CommunityForumsNNTPServer.NNTPServer
{
    public static class GeneralResponses
    {
      static GeneralResponses()
      {
        ...
        ServerReadyPostingAllowed = string.Format("200 Community Forums NNTP Server {0} Ready - posting allowed\r\n", fileVersion);
        ServerReadyPostingNotAllowed = string.Format("200 Community Forums NNTP Server {0} Ready - posting not allowed\r\n", fileVersion);
      }
        ...
        public static readonly string ServerReadyPostingAllowed = "200 Community Forums Bridge News Server Ready - posting allowed\r\n";
        public static readonly string ServerReadyPostingNotAllowed = "200 Community Forums Bridge News Server Ready - posting not allowed\r\n";
