...
```httprequest
GET http://forumsapi.msdn.microsoft.com/threads/{id}[?api-version={string}]
```
...
#### Sample request
```httprequest
GET http://fourmsapi.msdn.microsoft.com/threads/b16f7cb3-867a-4156-953c-3efc7a050ee2
```
    ...
    "values" : [ 
        {
            ...
            "url": "http://fourmsapi.msdn.microsoft.com/forums/threads/b16f7cb3-867a-4156-953c-3efc7a050ee2",
			...
			"modified": "2013-03-27T20:41:29.3160342Z",
            "createdBy": {
                "userId" : "502f2af9-2e96-47d7-9bfa-4769814ba9e6",
                "url" : "http://fourmsapi.msdn.microsoft.com/users/502f2af9-2e96-47d7-9bfa-4769814ba9e6"
            },
            "answers": 0,
            "proposedAnswers": 0,
			"views":300,
            ...
            "forum": {
                ...
                "url": "http://fourmsapi.msdn.microsoft.com/forums/6a68166e-b521-48a8-9454-ec36622eb8ae",
			...
			"repliesCount": 2,
			"repliesURL": "http://fourmsapi.msdn.microsoft.com/threads/b16f7cb3-867a-4156-953c-3efc7a050ee2/replies"
        }
    ]
}
```
...
```httprequest
GET http://fourmsapi.msdn.microsoft.com/forums/threads[?id={string}[,{string}]&page={integer}&pageSize={integer}&search={string}&createdById={string}&createdByName={string}&repliedById={string}&repliedByName={string}&forumId={string}&forumName={string}&categoryId={string}&categoryName={string}[,{string}]&type={string}&state={string}&createdFrom={string}&createdTo={string}&modifiedFrom={string}&modifiedTo={string}&sort={string}&brand={string}&locale={integer}&hasCode={boolean}&hasNoReplies={boolean}&isAbusive={boolean}&isHelpful={boolean}&minReplies={integer}&maxReplies={integer}&api-version={string}]
```
...
| createdById            | string   |         | The id of the user who created the thread.
| createdByName            | string   |         | The display name of the user who created the thread.
| repliedById            | string   |         | The id of the user. Threads which this user has replied to will be returned.
| repliedByName            | string   |         | The display name of the user. Threads which this user has replied to will be returned.
...
| modifiedFrom  | dateTime |         | The lower bound of the modification date and time.  Threads which have been modified in any way after this date and time will be returned.
| modifiedTo    | dateTime |         | The upper bound of the modification date and time.  Threads which have been modified in any way before this date and time will be returned.
...
#### Sample request
```httprequest
GET http://forumapi.msdn.microsoft.com/threads?threadId=b16f7cb3-867a-4156-953c-3efc7a050ee2,515bed28-1ba8-4e2e-9626-6538df9fe218
```
    ...
    "values" : [ 
        {
            "id":"b16f7cb3-867a-4156-953c-3efc7a050ee2",
            "title":"How to get the results in sql as pivot pleas?",
            "url": "http://forumapi.msdn.microsoft.com/threads/b16f7cb3-867a-4156-953c-3efc7a050ee2",
            "webUrl": "http://social.msdn.microsoft.com/forums/en-us/b16f7cb3-867a-4156-953c-3efc7a050ee2",
            "type":"Question",
			"state": "answered",
            "hasCode":true,
            ...
            "createdBy": {
                ...
                "url" : "http://forumapi.msdn.microsoft.com/users/502f2af9-2e96-47d7-9bfa-4769814ba9e6"
            },
            "answers":1,
            "proposedAnswers":1,
			"views":300,
            ...
            "forum":{
                "id":"6a68166e-b521-48a8-9454-ec36622eb8ae",
                "url": "http://forumapi.msdn.microsoft.com/forums/6a68166e-b521-48a8-9454-ec36622eb8ae",
                "webUrl": "http://social.msdn.microsoft.com/Forums/en-US/home?forum=fsharpgeneral",
                "type": "forum",
                "displayName":"F#"
            },
			...
			"body" : "&lt;p&gt;Uhmm !!! entendi o que vc queria !!! &lt;/p&gt;\r\n&lt;p&gt;para saber se a data &#233; v&#225;lida eu fa&#231;o de uma forma muito simples , &lt;/p&gt;\r\n&lt;p&gt;// pego a data que o cara digitou e tento converter para DateTime , se funcionar &#233; v&#225;lida , se n&#227;o , a data esta inv&#225;lida ... veja como faz ...&lt;/p&gt;\r\n&lt;p&gt;public static bool DataV&#225;lida(string Texto)&lt;/p&gt;\r\n&lt;p&gt;{&lt;/p&gt;\r\n&lt;p&gt;&#160; try&lt;/p&gt;\r\n&lt;p&gt;&#160; {&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; DateTime Dt = Convert.ToDateTime(texto);&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; return true;&lt;/p&gt;\r\n&lt;p&gt;&#160; }&lt;/p&gt;\r\n&lt;p&gt;&#160; catch&lt;/p&gt;\r\n&lt;p&gt;&#160; {&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; return false;&lt;/p&gt;\r\n&lt;p&gt;&#160; }&lt;/p&gt;\r\n&lt;p&gt;}&lt;/p&gt;\r\n&lt;p&gt;... t+&lt;/p&gt;",
			"repliesCount": 5,
			"repliesURL": "http://api.msdn.microsoft.com/threads/b16f7cb3-867a-4156-953c-3efc7a050ee2/replies"
        }
    ]
}
```
...
#### Sample request
```httprequest
GET http://forumsapi.msdn.microsoft.com/threads?createdBy=4d39b289-6acc-4cd1-97c4-6535b819671f&search=jscript&forumId=42b91635-70bd-49ab-a143-ef01bb5186d6&brand=microsoft&hasCode=1&helpful=0&noreplies=0&minReplies=1&modifiedFrom=2009-03-24T21:32:46&to=2014-01-01&page=1&pageSize=50
```
    ...
    "values" : [ 
        {
            ...
            "url": "http://forumsapi.msdn.microsoft.com/forums/threads/6d14c435-b96c-4c5e-a7f3-fa9af42520de",
            ...
            "createdBy": {
                "id" : "502f2af9-2e96-47d7-9bfa-4769814ba9e6",
                "url" : "http://forumsapi.msdn.microsoft.com/users/502f2af9-2e96-47d7-9bfa-4769814ba9e6"
            },
            "answers":0,
            "proposedAnswers":0,
			"views":300,
            ...
            "forum":{
                ...
                "url": "http://forumsapi.msdn.microsoft.com/forums/6a68166e-b521-48a8-9454-ec36622eb8ae",
                "webUrl": "http://social.msdn.microsoft.com/Forums/en-US/home?forum=fsharpgeneral",
                "type": "forum",
                "displayName":"F#"
            },
			...
			"body" : "&lt;p&gt;Uhmm !!! entendi o que vc queria !!! &lt;/p&gt;\r\n&lt;p&gt;para saber se a data &#233; v&#225;lida eu fa&#231;o de uma forma muito simples , &lt;/p&gt;\r\n&lt;p&gt;// pego a data que o cara digitou e tento converter para DateTime , se funcionar &#233; v&#225;lida , se n&#227;o , a data esta inv&#225;lida ... veja como faz ...&lt;/p&gt;\r\n&lt;p&gt;public static bool DataV&#225;lida(string Texto)&lt;/p&gt;\r\n&lt;p&gt;{&lt;/p&gt;\r\n&lt;p&gt;&#160; try&lt;/p&gt;\r\n&lt;p&gt;&#160; {&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; DateTime Dt = Convert.ToDateTime(texto);&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; return true;&lt;/p&gt;\r\n&lt;p&gt;&#160; }&lt;/p&gt;\r\n&lt;p&gt;&#160; catch&lt;/p&gt;\r\n&lt;p&gt;&#160; {&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; return false;&lt;/p&gt;\r\n&lt;p&gt;&#160; }&lt;/p&gt;\r\n&lt;p&gt;}&lt;/p&gt;\r\n&lt;p&gt;... t+&lt;/p&gt;",
			"repliesCount": 4,
			"repliesURL": "http://forumsapi.msdn.microsoft.com/threads/6d14c435-b96c-4c5e-a7f3-fa9af42520de/replies"
        },
        {
			...
			"body" : "&lt;p&gt;Uhmm !!! entendi o que vc queria !!! &lt;/p&gt;\r\n&lt;p&gt;para saber se a data &#233; v&#225;lida eu fa&#231;o de uma forma muito simples , &lt;/p&gt;\r\n&lt;p&gt;// pego a data que o cara digitou e tento converter para DateTime , se funcionar &#233; v&#225;lida , se n&#227;o , a data esta inv&#225;lida ... veja como faz ...&lt;/p&gt;\r\n&lt;p&gt;public static bool DataV&#225;lida(string Texto)&lt;/p&gt;\r\n&lt;p&gt;{&lt;/p&gt;\r\n&lt;p&gt;&#160; try&lt;/p&gt;\r\n&lt;p&gt;&#160; {&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; DateTime Dt = Convert.ToDateTime(texto);&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; return true;&lt;/p&gt;\r\n&lt;p&gt;&#160; }&lt;/p&gt;\r\n&lt;p&gt;&#160; catch&lt;/p&gt;\r\n&lt;p&gt;&#160; {&lt;/p&gt;\r\n&lt;p&gt;&#160;&#160;&#160; return false;&lt;/p&gt;\r\n&lt;p&gt;&#160; }&lt;/p&gt;\r\n&lt;p&gt;}&lt;/p&gt;\r\n&lt;p&gt;... t+&lt;/p&gt;",
			"repliesCount": 7,
			"repliesURL": "http://forumsapi.msdn.microsoft.com/threads/44a9f572-2a47-49a3-b419-f373805bc788/replies"
        }
    ]
}
```
...
```httprequest
POST http://forumsapi.msdn.microsoft.com/threads
```
    ...
    "values" : [ 
        {
			...
			"body" : "<p>Goal:<br />The input data that is located inside of the textbox search (usercontrol_menu.xaml) shall be transferred and then to be used inside of usercontrol_number1.xaml. </p><p>Problem:<br />I don't know what to do. What tactics and how to do it? From your experience, how should you do it? </p><p>Information:<br />- MainWindows.xaml is located in a separated project.</p><p></p><p><img alt="" src="http://social.msdn.microsoft.com/Forums/getfile/483597" /></p><br />",
			"repliesCount": 0,
			"repliesURL": "http://forumsapi.msdn.microsoft.com/threads/906c5f4a-4065-46e2-a8f9-dec37d235418/replies"
        }
    ]
}
```
...
```httprequest
GET http://forumsapi.msdn.microsoft.com/threads/{id}/replies
```
...
#### Sample request
```httprequest
GET http://forumsapi.msdn.microsoft.com/threads/b16f7cb3-867a-4156-953c-3efc7a050ee2/replies
```
#### Sample response
...
```httprequest
POST http://forumsapi.msdn.microsoft.com/forums/threads/{id}/replies
```
...
#### Sample request
```httprequest
POST http://forumsapi.msdn.microsoft.com/forums/threads/65d55f93-d262-4526-b53c-17336df4baed/replies
```
```json
{
