...
#### Sample request
```httprequest
GET http://api.msdn.microsoft.com/forums/7a9b8c49-06ac-44fe-b0fd-81485bd31386
```
    ...
    "values" : [ 
        {
            ...
            "name": "2018",
            "url": "http://api.msdn.microsoft.com/forums/7a9b8c49-06ac-44fe-b0fd-81485bd31386",
...
```httprequest
GET https://api.msdn.microsoft.com/forums[?forum={string}[,{string}]&category={string}[,{string}]&brand={string}&type={string}[,{string}]&locale={string}&threadCreatedFrom={dateTime}&threadCreatedTo={dateTime}&messageCreatedFrom={dateTime}&messageCreatedTo={dateTime}&sort={string}&order={string}&page={integer}&pageSize={integer}&api-version={float}]
```
...
| category               | string   |         | The name or id of the of the forum category.  Forums in this category will be returned. A comma-separated list of categories may be supplied, in which case all categories must be matched by a forum to be included in the result set.
...
| messageCreatedFrom  | dateTime |         | The minimum message creation date.  Only forums with a message created on or after this date will be returned.
| messageCreatedTo    | dateTime |         | The maximum message creation date.  Only forums with a message created onr or before this date will be returned.
| sort                   | string   | threadDate | The sort order of returned threads.  Valid values are "threadDate", "messageDate".
...
#### Sample request
```httprequest
GET http://api.msdn.microsoft.com/forums?forum=2dac51a6-0bcd-4ad7-b4d3-3f49fb3fe002,1ac816b4-e220-44ca-91c1-6f9f414c3ec6
```
    ...
    "values" : [ 
        {
            ...
            "url": "http://api.msdn.microsoft.com/forums/2dac51a6-0bcd-4ad7-b4d3-3f49fb3fe002",
...
#### Sample request
```httprequest
GET http://api.msdn.microsoft.com/forums?locale=1033&threadCreatedFrom=2014-05-15&type=forum&brand=technet&sort=threadDate
```
